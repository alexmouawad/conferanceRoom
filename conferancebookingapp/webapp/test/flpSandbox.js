		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comconferancebookingapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comconferancebookingapp-display": {
								"semanticObject": "comconferancebookingapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.conferancebookingapp",
									"url": sap.ui.require.toUrl("com/conferancebookingapp")
								}
							}
						}
					}
